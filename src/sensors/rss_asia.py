...
FEEDS = [
    {"title": "SCMP China",         "url": "https://www.scmp.com/rss/4/feed"},
    {"title": "SCMP Asia",          "url": "https://www.scmp.com/rss/3/feed"},
    {"title": "NHK World",          "url": "https://www3.nhk.or.jp/rss/news/cat0.xml"},
    {"title": "Yonhap Korea",       "url": "https://en.yna.co.kr/RSS/national.xml"},
    {"title": "Straits Times Asia", "url": "https://www.straitstimes.com/news/asia/rss.xml"},
...
def fetch_asia_news(limit: int = 10) -> List[NewsArticle]:
    articles = []
    seen_titles = set()
    ...
    for feed_cfg in FEEDS:
        try:
            ...
            logger.warning(f"[rss_asia] {feed_cfg['title']} failed: {e}")
