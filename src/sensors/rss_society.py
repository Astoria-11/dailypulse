...
FEEDS = [
    ...
    {"title": "UN News",            "url": "https://news.un.org/feed/subscribe/en/news/all/rss.xml"},
    {"title": "AP International",   "url": "https://rsshub.app/apnews/topics/apf-intlnews"},
...
def fetch_society_news(limit: int = 8) -> List[NewsArticle]:
    articles = []
    seen_titles = set()
    ...
    for feed_cfg in FEEDS:
        try:
            ...
            logger.warning(f"[rss_society] {feed_cfg['title']} failed: {e}")
